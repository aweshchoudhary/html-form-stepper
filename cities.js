...
const statesInput = document.querySelector("#state-menu");
const states = data.map((e) => {
  return e.state;
});
const state = removeDuplicates(states);
state.sort();
state.map((e) => {
  return statesInput.insertAdjacentHTML(
    "beforeend",
...
const place = () => {
  const states = document.querySelector("#state-menu");
  const citiesInput = document.querySelector("#city-menu");
  if (states.value) {
    citiesInput.style.display = "block";
    data.map((e) => {
      if (e.state === states.value) {
        citiesInput.insertAdjacentHTML(
          "beforeend",
